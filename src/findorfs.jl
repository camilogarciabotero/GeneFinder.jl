...
"""
    findorfs(sequence::NucleicSeqOrView{DNAAlphabet{N}}; method=naivefinder, alternative_start=false, min_len=6) where {N}
...
- `method`: The algorithm used to find ORFs. Default is `naivefinder`.
